  ...
  <div>
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('dashboard')">
        <icon name="dashboard" class="w-4 h-4 mr-2" :class="isUrl('dashboard') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('tags')">
        <icon name="users" class="w-4 h-4 mr-2" :class="isUrl('tags') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('tags') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Tags</div>
      </inertia-link>
    </div>
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('portfolios')">
        <icon name="users" class="w-4 h-4 mr-2" :class="isUrl('portfolios') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('portfolios') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Portfolio</div>
      </inertia-link>
    </div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('notes')">
        <icon name="users" class="w-4 h-4 mr-2" :class="isUrl('notes') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('notes') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Notes</div>
      </inertia-link>
    </div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('terminal.orders')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('terminal.settings')">
